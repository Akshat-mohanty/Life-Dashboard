        ...
        <div className="flex items-center gap-2.5 min-w-0">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h3 className="font-bold text-zinc-900 text-sm tracking-tight whitespace-nowrap">Health & Habits</h3>
              ...
              {summary.smsAlertsEnabledCount > 0 && (
                <span className="text-[10px] text-zinc-400 font-medium hidden sm:inline whitespace-nowrap">
