        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h3 className="font-bold text-zinc-900 text-sm tracking-tight">Bills & Payments</h3>
            ...
            <p className="text-[11px] text-zinc-400">Track due dates & recurring expenses</p>
          </div>
        </div>
      ...
      <div className="mt-4 flex-1 overflow-y-auto space-y-2.5 max-h-[420px] pr-0.5">
        {isLoading ? (
          ...
          <div className="text-center py-6 px-4 bg-zinc-50/50 rounded-xl border border-dashed border-zinc-200">
            ...
            <p className="text-[11px] text-zinc-400 mt-0.5">Track subscriptions, utilities, and rent</p>
          </div>
        ) : (
