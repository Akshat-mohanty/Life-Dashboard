...
export default function Bills() {
  ...
  return (
    <div className="bg-white rounded-2xl border border-zinc-200 p-6 shadow-sm flex flex-col h-full hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
      {/* Header */}
